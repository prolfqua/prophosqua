...
(totXlsx  <-  paste0("DEA_20250423_PIp38066_Oo38066_WUTotalProteome_none/Results_WU_TotalProteome/DE_DEA_20250423_PIp38066_Oo38066_WUTotalProteome_none_WUTotalProteome.xlsx"))
(phosXlsx <- paste0("p38066_PhosphoEnriched_wt_VS_ko/DEA_20250423_PIp38066_Oo38066_WUPhosphoEnriched_none/Results_WU_PhosphoEnriched/DE_WUPhosphoEnriched.xlsx"))
...
fasta_file = "../o38066_FPcomplete_input/o38066_input/2025-04-10-decoys-reviewed-contam-UP000000589.fasta"


# source helper functions
#source("/Users/jonasgrossmann/GitHub/prophosqua/R/FP_phosphoHelperFunctions_v3_202310.R")
seq_window <- get_sequence_windows(phosRes, fasta_file, rev_pattern) # this works after build n reinstall
...
drumm <- prolfquapp::make_DEA_config_R6(
  ...
  ORDERID = OIDfgcz,
  WORKUNITID = descri)
# some render params to be defined in yaml phos res
...
writexl::write_xlsx(excelResultList, path = file.path(resDir,"PhosphoAndTotal.xlsx"))
#
