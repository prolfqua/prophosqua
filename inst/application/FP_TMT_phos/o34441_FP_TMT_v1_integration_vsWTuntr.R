...
totRes <- read.xlsx(xlsxFile = "o34441_FPguiTMTphospho__TotalProteome/DE_Groups_vs_Controls/DE_Groups_vs_Controls.xlsx", sheet = "diff_exp_analysis")
phosRes <- read.xlsx(xlsxFile = "o34441_FPguiTMTphospho__PhosphoEnriched/DE_Groups_vs_Controls/DE_Groups_vs_Controls.xlsx", sheet = "diff_exp_analysis")

# here only non-decoy DBs otherwise we hit the accession twice!
