...
# variables
WUID <- "specifiedContrasts_onlyToxoP"
fgczProject <- "p37382"
OIDfgcz <- "o37382"
fracti <- "Integration"
...
(totXlsx  <-  paste0("DEA_20250226_PIp37382_Oo37382_WUTotalProteome_onlyToxP_none/Results_WU_TotalProteome_onlyToxP/DE_DEA_20250226_PIp37382_Oo37382_WUTotalProteome_onlyToxP_none_WUTotalProteome_onlyToxP.xlsx"))
(phosXlsx <- paste0("p37382_PhosphoEnriched_onlyToxoP_PhosphoEnriched_onlyToxoP/DEA_20250226_PIp37382_Oo37382_WUPhosphoEnriched_onlyToxoP_none/Results_WU_PhosphoEnriched_onlyToxoP/DE_WUPhosphoEnriched_onlyToxoP.xlsx"))
...
fasta_file = "../proteome/2025-01-17-decoys-reviewed-contam-UP000005640-spikein.fasta"
...
writexl::write_xlsx(excelResultList, path = file.path(resDir,"PhosphoAndTotal_Integration_onlyToxoP.xlsx"))
#


# Function to determine the significance for plotting NtoC
fdrThreshold = 0.000000001
