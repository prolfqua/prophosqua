...
(ref:scatterplot) PTM site differences (Y axis) as a function of protein differences (X axis).
...
colnames(data_diff_diff)

#datax <- datax |> tidyr::unite("modelName", c("modelName.site", "modelName.protein"), sep = "~")
#datax$modelName |> table()
