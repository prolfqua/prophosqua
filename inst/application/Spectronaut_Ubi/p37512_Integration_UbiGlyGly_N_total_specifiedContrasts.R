...
(totXlsx  <-  paste0("DEA_p37512_20250210_TotalProteome_selfSpecifiedContrasts/DEA_20250210_PIp37512_OspecifiedContrasts_WUTotalProteome_robscale/Results_WU_TotalProteome/DE_WUTotalProteome.xlsx"))
(ubiXlsx <- paste0("DEA_20250210_p37512_enriched_ubi/Results_WU_enriched/DE_WUenriched.xlsx"))
...
fasta_file = "../Spectronaut_Reports/proteome/fgcz_9606_1spg_20230330.fasta"
