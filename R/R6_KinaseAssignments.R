...
KinaseAssignments <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(source, analysis, result = .compute_kinaseassignments_stage(source, analysis)) {
      if (!inherits(source, "KinaseInputs")) {
        stop("KinaseAssignments requires KinaseInputs")
      }
      ...
      .require_ptm_fields(result, "term2gene", "KinaseAssignments")
