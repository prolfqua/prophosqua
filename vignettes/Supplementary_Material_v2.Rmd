...
author: "Witold Wolski, Antje Dittmann, Jonas Grossmann"
params:
  wd: ""
  dodea: TRUE
output:
...
4. **Multi-panel visualization** - Creates sequence logos for each contrast showing up and downregulation in 2-column layout for easy comparison
5. **Probability-based display** - Shows amino acid frequencies.

The analysis focuses on sites with strong statistical evidence of differential usage ($FDR_I < 0.01$ and $\Delta I > 0.58$) to ensure that motif patterns reflect genuine biological changes rather than technical artifacts.

## C.2 Filtering data for sequence logo plotting {-}
...
## C.3 Making sequence logos {-}

Before generating sequence logos, we need to ensure the sequence windows are properly centered on the phosphorylation site. This code validates that the 7th character (center position) of each sequence window matches the reported modified amino acid.
...
Generate sequence logos for significantly regulated serine phosphorylation sites. The plots are organized by contrast and regulation direction (up/down) to identify kinase-specific motifs.
...
Generate sequence logos for significantly regulated threonine phosphorylation sites. Threonine sites may show different kinase preferences compared to serine sites.
...
## C.4 Interpreting the sequence logos {-}
...
## D.2 Troubleshooting Common Issues {-}
...
### D.2.1 Data Integration Problems {-}
...
### D.2.2 Statistical Analysis Issues {-}
...
### D.2.3 Computational Performance Issues {-}
...
### D.2.4 Biological Interpretation Challenges {-}
...
## D.3 Quality Control Recommendations {-}
...
# E. Software Versions and Session Information {-}
