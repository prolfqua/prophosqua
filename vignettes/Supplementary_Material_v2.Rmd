...
- **R version**: ≥ 4.0.0
- **Required packages**: `prolfquapp`, `prophosqua`, `tidyverse`, `ggseqlogo`
...
1. **Filtering data** - Filters for significantly regulated sites (FDR_I < 0.05) and includes only the main comparison of interest (KO vs WT)
...
## D. Software Versions and Session Information
