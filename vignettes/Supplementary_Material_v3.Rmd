...
```{r fig5seqlogoST_compute, fig.width=9, fig.height=12}
...
abbreviation_table <- data.frame(
  ...
  Definition = c("Bovine Serum Albumin", "Chloroacetamide", "Coefficient of Variation",
                 ...
                 "Identification", "Immobilized Metal Affinity Chromatography",
...
```{r fig2usageQ64337, fig.cap="(ref:fig2usageQ64337)", echo=FALSE}
fig2_plot
```
...
(ref:fig4FDRcorrfirst) Volcano plot showing the -log10(FDR) as a function of the PTM site fold change.
...
```{r fig5seqlogoST, fig.width=9, fig.height=12, fig.cap="(ref:fig5seqlogoST)", echo=FALSE}
fig5_plot
```
