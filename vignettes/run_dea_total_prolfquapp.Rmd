...
```
After running the differential expression analysis, the results are stored in a timestamped directory. This code constructs the path to the results directory using the `prolfquapp::zipdir_name()` function, which follows the standard naming convention for DEA results.
