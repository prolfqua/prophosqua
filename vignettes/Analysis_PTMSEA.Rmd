...
```{r contrastPlots, results='asis', fig.height=8, eval=has_ptmsea_results}
...
```{r combinedDotplot, fig.width=14, fig.height=10, eval=has_ptmsea_results}
...
```{r individualPlots, fig.width=14, fig.height=10, results='asis', eval=has_ptmsea_results}
...
```{r summaryHeatmap, fig.width=12, fig.height=10, eval=has_ptmsea_results}
stopifnot(
...
```{r volcanoPlot, fig.width=12, fig.height=8, eval=has_ptmsea_results}
...
```{r gseaExamplePlots, results='asis', fig.width=10, fig.height=6, eval=has_ptmsea_results}
for (ct in names(results)) {
  cat("\n\n## ", ct, " {.tabset}\n\n")
